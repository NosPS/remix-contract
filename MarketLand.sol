...
contract Market is OCN {
    ...
    function purchase(address contractAddr, address coinAddr, uint256 tokenId, address referer, uint256 metaverseFee, uint256 previousOwnerFee, uint256 referalFee) public payable {
        Listing storage item = listings[contractAddr][tokenId];
        ERC1155 token = ERC1155(contractAddr);
    ...
    function purchaseBatch(address contractAddr, address coinAddr, uint256[] calldata tokenId, address referer, uint256 metaverseFee, uint256[] calldata previousOwnerFee, uint256 referalFee) public payable {
